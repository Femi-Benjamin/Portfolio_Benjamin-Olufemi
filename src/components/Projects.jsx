    ...
    >
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/** Show only first 3 projects unless user clicks "See more" */}
          {(() => {
        ...
        {ProjectsData.length > 3 && (
          <div className="mt-8 flex justify-center">
            <button
              ...
              className="px-6 py-2 rounded-full bg-cyan-500 text-slate-900 font-semibold hover:bg-cyan-400 transition-colors"
            >
