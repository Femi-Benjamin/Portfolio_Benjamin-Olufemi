...
const BackgroundOrbs = () => {
  return (
    <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
      ...
      {/* ================= DESKTOP ONLY: Fluid Animated Orbs ================= */}
      ...
      {/* ================= MOBILE ONLY: Static Lightweight Glow (Zero GPU Load) ================= */}
      <div className="block md:hidden">
        <div className="absolute w-72 h-72 bg-cyan-500/10 rounded-full blur-3xl -top-10 -left-10" />
        <div className="absolute w-72 h-72 bg-purple-600/10 rounded-full blur-3xl top-1/3 -right-10" />
        <div className="absolute w-72 h-72 bg-blue-600/10 rounded-full blur-3xl bottom-10 left-1/4" />
      </div>
